...
namespace Business.Concrete
{
    public class CarManager : ICarService
    {
       ...
       [CacheAspect]
        ...
        public IDataResult<List<CarColorBrandDto>> GetCarColorBrandDtao()
        {
            return new SuccessDataResult<List<CarColorBrandDto>>(_carDal.GetCarColorBrandDto(), Messages.Listed);
        }
